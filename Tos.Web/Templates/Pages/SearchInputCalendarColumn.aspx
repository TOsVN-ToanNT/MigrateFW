<%@ Page Title="TODO: 画面番号_画面名を設定します。" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchInputCalendarColumn.aspx.cs" Inherits="Tos.Web.Templates.Pages.SearchInputCalendarColumn" %>
<%@ MasterType VirtualPath="~/Site.Master" %>
<%--created from 【SearchInputCalendarColumn(Ver2.1)】 Template--%>
        ...
        */
        ...
        page.header.search = function () {
            ...
            page.header.validator.validate().done(function () {
                ...
                return $.ajax(App.ajax.webapi.get(/* TODO: 検索結果取得サービスの URL を設定してください。 ,*/ page.options.filter))
        ...
        page.header.createFilter = function () {
            var criteria = page.header.element.form().data(),
                ...
                filter = {
                    //dt_from: App.date.format(criteria.dt_from, "yyyy-MM-dd"),
                    //dt_to: App.date.format(criteria.dt_to, "yyyy-MM-dd")
                };
