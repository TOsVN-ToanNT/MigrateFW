<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchDialog.aspx.cs" Inherits="Tos.Web.Pages.SearchDialog" %>
    ...
    <script type="text/javascript">
        ...
        SearchDialog.search = function () {
            var element = SearchDialog.element,
                ...
                table = element.find(".search-list"),
                filter = SearchDialog.createFilter(),
                query;

            SearchDialog.validator.validate().done(function () {

                query = {
                    url: SearchDialog.urls.torihiki,
                    filter: filter,
                    orderby: "cd_torihiki",
                    skip: 0,
    ...
    <div class="modal-dialog" style="height: 350px; width: 60%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div style="height: 352px; overflow: scroll; overflow-x: hidden;">
